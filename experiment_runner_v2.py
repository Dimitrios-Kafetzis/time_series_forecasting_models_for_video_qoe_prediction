...
Usage Example:
    ...
    Optionally, if using the augmented dataset mode:
    $ python3 experiment_runner.py --data_folder ./augmented_dataset --epochs 20 --batch_size 16 --augmented
"""
...
def main():
    ...
    with open(args.output_csv, mode='w', newline='') as csvfile:
        ...
        for config in experiments:
            ...
            cmd = ["python3", "timeseries_forecasting_models_v2.py",
            ...
            # If augmented flag is set, add it to the command.
            if args.augmented:
