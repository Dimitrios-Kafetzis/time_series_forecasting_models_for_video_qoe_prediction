...
Description:
    ...
    Usage Examples:
      1. Train an LSTM model with self-attention on a regular dataset:
      ...
      2. Train a GRU model with self-attention on an augmented dataset (without extra statistics):
      ...
      4. Train bidirectional LSTM with self-attention:
      ...
      5. Automated Hyperparameter Tuning Examples (includes finding best parameters and final training):
...
# =============================================================================
# 3. Model Definitions (Modified to use Self-Attention)
# =============================================================================
...
def main():
    ...
    output_dir = "forecasting_models_v4"
